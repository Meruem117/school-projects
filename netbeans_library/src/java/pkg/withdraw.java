...
public class withdraw extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Logger logger = Logger.getLogger(withdraw.class.getName());
        ...
        try {
            ...
            if (rs1 > 0) {
                logger.info("user: "+n + "\tdelete"+"\tsucceed");
                RequestDispatcher rd = request.getRequestDispatcher("2.jsp");
                rd.forward(request, response);
            }
        } catch (SQLException ex) {
            java.util.logging.Logger.getLogger(withdraw.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
