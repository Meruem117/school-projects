...
//                .withColumnFields(new Fields("word"))
        ...
        HBaseBolt hBaseBolt = new HBaseBolt("p1", mapper).withConfigKey("hbase.conf");
        ...
        builder.setBolt("split-bolt", new SplitBolt2(), 4).shuffleGrouping("kafka-spout");
